...
from bot.channels.meinya_yozakura.profile_details import MEINYA_ACHIEVEMENT_NAMES, MEINYA_AD_ANNOUNCEMENT_MESSAGE, MEINYA_COMMUNITY_MESSAGES, MEINYA_LURK_MESSAGE, MEINYA_POINTS, MEINYA_RAID_BOSSES, MEINYA_RAID_MESSAGES, MEINYA_REDEEMS, MEINYA_SHOUTOUT_MESSAGES, MEINYA_SOCIAL_MESSAGES, MEINYA_TIMER_MESSAGES
...
MEINYA_PROFILE = ChannelProfile(
    ...
    achievement_names=MEINYA_ACHIEVEMENT_NAMES
)
