...
MEINYA_POINTS = PointsConfig(
    ...
    messages=PointsMessages(
        ...
        roulette_bet_invalid="Your roulette bet must be at least 1 sakura petal.",
        roulette_bet_maximum="The maximum roulette bet is {maximum} sakura petals.",
        roulette_insufficient="You only have {points} sakura petals.",
        roulette_win="The wheel landed on {number} {result}! {username} won {profit} sakura petals and now has {new_balance}!",
        roulette_loss="The wheel landed on {number} {result}. {username} lost {bet} sakura petals and now has {new_balance}.",
