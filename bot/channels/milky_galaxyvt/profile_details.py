...
MILKY_GALAXYVT_POINTS = PointsConfig(
    ...
    messages=PointsMessages(
        ...
        leaderboard_empty="No {currency} have been collected yet.",
        leaderboard_entry="{position}. {username}: {points} {currency}",
        leaderboard_title="Top star shard collectors: {leaderboard}",
        reset_denied="Only the broadcaster can reset the {currency}.",
        reset_success="The galaxy's {currency} have been reset.",
        add_denied="Only moderators can give viewers {currency}.",
        ...
        gamble_win="{username} found {amount} {currency} and now has {new_balance}!",
        ...
        gamble_all_loss="{username} lost all their {currency} in the void.",
        ...
        duel_challenge=(
            ...
            "{currency}! Type !{command} duel accept or !{command} duel decline. "
