...
class DeveloperPointsCommands(ChannelComponent):
    ...
    async def ores(self, ctx: commands.Context, target: User = None):
    ...
    async def ores_leaderboard(self, ctx: commands.Context):
        if not await self.require_profile_channel(ctx):
            return
    ...
    async def ores_reset(self, ctx: commands.Context):
        if not await self.require_profile_channel(ctx):
            return
    ...
    async def ores_add(self, ctx: commands.Context, target: User, amount: int):
        if not await self.require_profile_channel(ctx):
            return
    ...
    async def ores_gamble(self, ctx: commands.Context, amount: str):
        if not await self.require_profile_channel(ctx):
            return
    ...
    async def ores_duel(self, ctx: commands.Context, opponent: User = None, amount: str = None):
        if not await self.require_profile_channel(ctx):
            return
    ...
    async def ores_duel_accept(self, ctx: commands.Context):
        if not await self.require_profile_channel(ctx):
            return
    ...
    async def ores_duel_decline(self, ctx: commands.Context):
        if not await self.require_profile_channel(ctx):
            return
