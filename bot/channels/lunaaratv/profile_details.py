...
LUNAARATV_SOCIAL_MESSAGES = SocialMessages(
...
LUNAARATV_FIRST_CHAT_SHOUTOUTS = (
    FirstChatShoutout(
...
LUNAARATV_TIMER_MESSAGES = (
    "Timer Placeholder",
)


LUNAARATV_COMMUNITY_MESSAGES = CommunityMessages(
    ...
    gifted_subscription="Thank you {username} for gifting {count} {subscription_word} under Luna's moon!"
)


LUNAARATV_RAID_MESSAGES = RaidMessages(
    incoming=(
...
LUNAARATV_SHOUTOUT_MESSAGES = ShoutoutMessages(
    with_game=(
...
LUNAARATV_REDEEMS = RedeemConfig(
