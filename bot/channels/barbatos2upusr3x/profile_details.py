...
BARBATOS2UPUSR3X_SOCIAL_MESSAGES = SocialMessages(
...
BARBATOS2UPUSR3X_FIRST_CHAT_SHOUTOUTS = (
    FirstChatShoutout(
...
BARBATOS2UPUSR3X_CLIPS = ClipConfig(
    duration=60,
    short_duration=30,
...
BARBATOS2UPUSR3X_COMMUNITY_MESSAGES = CommunityMessages(
    ...
    gifted_subscription="Thank you {username} for gifting {count} {subscription_word} to the Barbatos crew!"
)


BARBATOS2UPUSR3X_RAID_MESSAGES = RaidMessages(
    incoming=(
...
BARBATOS2UPUSR3X_SHOUTOUT_MESSAGES = ShoutoutMessages(
    with_game=(
...
BARBATOS2UPUSR3X_REDEEMS = RedeemConfig(
