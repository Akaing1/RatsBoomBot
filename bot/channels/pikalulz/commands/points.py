...
class PikalulzPointsCommands(ChannelComponent):
    ...
    @commands.group(name="pikalulz_placeholder_points", invoke_fallback=True, case_insensitive=True)
    async def points(self, ctx: commands.Context, target: LocalizedUser = None) -> None:
        ...
        await self.handler.show_balance(ctx, target, "pikalulz_placeholder_points")
    ...
    async def points_leaderboard(self, ctx: commands.Context) -> None:
        ...
        await self.handler.show_leaderboard(ctx, "pikalulz_placeholder_points")
    ...
    async def points_reset(self, ctx: commands.Context) -> None:
        ...
        await self.handler.reset_points(ctx, "pikalulz_placeholder_points")
    ...
    async def points_add(self, ctx: commands.Context, target: LocalizedUser, amount: int) -> None:
        ...
        await self.handler.add_points(ctx, target, amount, "pikalulz_placeholder_points")
    ...
    async def points_give(self, ctx: commands.Context, target: LocalizedUser, amount: int) -> None:
        ...
        await self.handler.give_points(ctx, target, amount, "pikalulz_placeholder_points")
    ...
    async def points_gamble(self, ctx: commands.Context, amount: str) -> None:
        ...
        await self.handler.gamble(ctx, amount, "pikalulz_placeholder_points")
    ...
    async def points_roulette(self, ctx: commands.Context, color: str = None, amount: str = None) -> None:
        ...
        await self.handler.roulette(ctx, color, amount, "pikalulz_placeholder_points")
    ...
    async def points_duel(self, ctx: commands.Context, opponent: LocalizedUser = None, amount: str = None) -> None:
        ...
        await self.handler.create_duel(ctx, opponent, amount, "pikalulz_placeholder_points")
    ...
    async def points_duel_accept(self, ctx: commands.Context) -> None:
        ...
        await self.handler.accept_duel(ctx, "pikalulz_placeholder_points")
    ...
    async def points_duel_decline(self, ctx: commands.Context) -> None:
        ...
        await self.handler.decline_duel(ctx, "pikalulz_placeholder_points")
