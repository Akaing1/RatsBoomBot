...
PIKALULZ_SOCIAL_MESSAGES = SocialMessages(
...
PIKALULZ_RAID_MESSAGES = RaidMessages(
    incoming=(
...
PIKALULZ_SHOUTOUT_MESSAGES = ShoutoutMessages(
    with_game=(
...
PIKALULZ_POINTS = PointsConfig(
    command_name="pikalulz_placeholder_points",
