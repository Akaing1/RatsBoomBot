...
NINJAKAING_REDEEMS = RedeemConfig(
    ...
    messages=RedeemMessages(
        ...
        daily_already_claimed="@{username}, you already claimed your stream daily stale bread.",
        daily_success=(
        ...
        daily_milestone="Milestone! @{username} has collected their daily stale bread {claim_count} times!",
        first_already_claimed_by="@{username}, this stream's first redeem was already claimed by @{winner}.",
        first_already_claimed="@{username}, this stream's first redeem was already claimed.",
        first_success=(
        ...
        first_milestone="Milestone! @{username} has stolen the first bread {claim_count} times!"
    )
)
...
NINJAKAING_POINTS = PointsConfig(
    ...
    messages=PointsMessages(
        ...
        reset_success="This channel's stale bread has been thrown away. The leaderboard has been reset.",
        ...
        gamble_win="{username} found {amount} stale bread on the ground and now has {new_balance} bread.",
        gamble_all_win="{username} raided the pantry and found a hidden stash of stale bread! You now have {new_balance} bread.",
        gamble_loss="{username} got caught by a rat trap and lost {amount} stale bread and now has {new_balance} bread.",
        gamble_all_loss="{username} got into a fight with the other rats and got mugged. You lost all your stale bread.",
        ...
        duel_missing="You don't have any pending bread duels, or your duel has expired.",
        duel_cancelled="This duel was cancelled because someone no longer has enough stale bread.",
