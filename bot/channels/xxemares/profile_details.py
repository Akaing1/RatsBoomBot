...
XXEMARES_SOCIAL_MESSAGES = SocialMessages(
...
XXEMARES_COMMUNITY_MESSAGES = CommunityMessages(
    ...
    gifted_subscription="Thank you {username} for gifting {count} {subscription_word} to the nightmare crew!"
)


XXEMARES_RAID_MESSAGES = RaidMessages(
    incoming=(
...
XXEMARES_SHOUTOUT_MESSAGES = ShoutoutMessages(
    with_game=(
