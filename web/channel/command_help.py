...
UTILITY_COMMANDS = CommandGroupDefinition(
    ...
    commands=(
        ...
        CommandDefinition("!stinky [username]", "Generate one stinky percentage per viewer during each live stream.", global_command=GlobalCommandName.STINKY),
        CommandDefinition("!lucky [username]", "Generate one luck percentage per viewer during each live stream.", global_command=GlobalCommandName.LUCKY),
        CommandDefinition("!smart [username]", "Generate one smart percentage per viewer during each live stream.", global_command=GlobalCommandName.SMART),
        CommandDefinition("!height [username]", "Generate one height per viewer during each live stream, from 1' 0\" through 8' 0\".", global_command=GlobalCommandName.HEIGHT),
