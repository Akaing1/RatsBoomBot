...
Global achievement unlocks remain silent and award badges only. Channel achievements and their point rewards are documented separately in `docs/channel-achievements.md`. XP, channel levels, raid awards, and leaderboards remain on standby.
