...
Eight secret channel Platinum badges unlock for exact outcomes: `!stinky` at 0% or 100%, `!smart` at 0% or 100%, `!height` at exactly 1'0" or 8'0", and `!lucky` at 0% or 100%. The person measured earns the badge, whether they issued the command or were named as the target. Each achievement awards 25,000 channel loyalty points once; ordinary rolls are not stored.
