...
Eight secret channel Platinum badges unlock for exact outcomes: `!stinky` at 0% or 100%, `!smart` at 0% or 100%, `!height` at exactly 1'0" or 8'0", and `!lucky` at 0% or 100%. These four commands are available only while the channel is live, and each measured viewer receives one result per command per stream. The person measured earns the badge, whether they issued the command or were named as the target. Each achievement awards 25,000 channel loyalty points once.
